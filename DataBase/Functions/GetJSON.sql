...
-- Description: Serializa una tabla a un Json string
-- Uso: exec dbo.GetJSON 'dbo.EmpresaMoneda'
-------------------------------------------------------
CREATE OR ALTER PROCEDURE dbo.GetJSON @ObjectName VARCHAR(255), @registries_per_request smallint = null
AS
BEGIN
